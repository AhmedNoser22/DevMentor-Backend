        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CertificateCode = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScorePercentage = table.Column<int>(type: "int", nullable: true),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    TimesReported = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TechnicalAccuracyFeedback = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    MissingConceptsFeedback = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    CommunicationFeedback = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    Score = table.Column<int>(type: "int", nullable: true),
                    FollowUpQuestion = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Certificates_UserId_Domain_Level",
                table: "Certificates",
                columns: new[] { "UserId", "Domain", "Level" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamAttempts_UserId_Domain_Level_Status",
                table: "ExamAttempts",
                columns: new[] { "UserId", "Domain", "Level", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_InterviewSessions_UserId_StartedAtUtc",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Questions_Domain_Level_Status",
                table: "Questions",
                columns: new[] { "Domain", "Level", "Status" });
